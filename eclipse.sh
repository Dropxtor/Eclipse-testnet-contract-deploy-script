...
if [ "$choice" -eq 1 ]; then
    ...
    echo -e "${YELLOW}Sauvegardez ces phrases mnémotechniques dans un endroit sûr. Si il y a une distribution d'airdrop à l'avenir, vous serez éligible avec ce portefeuille, donc sauvez-le.${NC}"
...
echo
echo -e "${GREEN}Sauvegardez cette clé privée dans un endroit sûr. Si il y a une distribution d'airdrop à l'avenir, vous serez éligible avec ce portefeuille, donc sauvez-le.${NC}"
echo
